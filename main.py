...
resultDir="LTSpiceSimResults/fullN3_3_3.json"
...
obj=Module(VPPMfreq,1000,numPointsPerPeriod,numSamples,0.2,0,0,22,[-1,1e-8])
obj.GenerateInput()
addicionalNoises=GenerateOtherWaves("0.0","0.0",obj,True)
